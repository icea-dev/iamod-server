...
revision 0.3  2017/ago  samuel miranda
implementação do forwarder asterix
leitura de todos os parametros do arquivo de configuração
...
class CIAMODServer(object):
    """
    BusterServer class
    """
    # ---------------------------------------------------------------------------------------------
    def __init__(self, fs_config="iamod_server.cfg"):
        """
        constructor
        """ 
        # init super class
        super(CIAMODServer, self).__init__()
    ...
    def __process_msg(self, fs_adsb_msg, fv_del=False):
        ...
        # determine reliability of messagecurity.bu
